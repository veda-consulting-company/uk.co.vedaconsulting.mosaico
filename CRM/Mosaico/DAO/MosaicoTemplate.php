 ...
 * (GenCodeChecksum:19f444ef494404991a83caa1006d9aab)
 */
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = [
        'id' => [
          ...
          'description' => ts('Unique Template ID'),
          'required' => TRUE,
        ...
        'base' => [
          ...
          'description' => ts('Name of the Mosaico base template (e.g. versafix-1)'),
          'maxlength' => 64,
        ...
        'html' => [
          ...
          'title' => ts('HTML'),
          'description' => ts('Fully renderd HTML'),
        ...
        'metadata' => [
          ...
          'type' => CRM_Utils_Type::T_LONGTEXT,
          'title' => ts('metadata'),
          'description' => ts('Mosaico metadata (JSON)'),
        ...
        'content' => [
          ...
          'type' => CRM_Utils_Type::T_LONGTEXT,
          'title' => ts('Content'),
          'description' => ts('Mosaico content (JSON)'),
        ...
        'msg_tpl_id' => [
          ...
          'description' => ts('FK to civicrm_msg_template.'),
          'required' => FALSE,

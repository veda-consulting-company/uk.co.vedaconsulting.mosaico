(function (angular, $, _) {
  ...
  angular.module('crmMosaico').factory('crmMosaicoTemplates', function ($q, crmApi) {
    ...
    var exMetadata = '{"created":1480972208311,"key":"8m0qymc","name":"My Example Template","template":"'+
      // '/sites/all/modules/civicrm/ext/uk.co.vedaconsulting.mosaico/packages/mosaico/templates'+
      tplsUrl +
      '/versafix-1/template-versafix-1.html","editorversion":"0.15.0","templateversion":"1.0.5","changed":1480972251321}';
